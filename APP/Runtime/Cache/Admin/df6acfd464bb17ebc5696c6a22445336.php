...
<td class="st"><?php echo ($app["title"]); ?></td>
<td>[<a href="<?php echo U('Admin/Rbac/addNode', array('pid'=>$app['id'],'level'=>2));?>">添加控制器</a>]&nbsp;[<a href="">修改</a>]&nbsp;[<a href="">删除</a>]</td>
</tr>
<?php if(is_array($app["child"])): foreach($app["child"] as $key=>$action): ?><tr>
<td class="at"><?php echo ($action["title"]); ?></td>
<td>[<a href="<?php echo U('Admin/Rbac/addNode', array('pid'=>$action['id'],'level'=>3));?>">添加方法</a>]</td>
</tr>
<tr>

<?php if(is_array($action["child"])): foreach($action["child"] as $key=>$method): ?><td>&nbsp;·<?php echo ($method["title"]); ?>[<a href="">修改</a>][<a href="">删除</a>]</td><?php endforeach; endif; ?>
